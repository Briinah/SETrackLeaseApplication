...
import Backend.vehicles.Vehicle;

import static java.time.LocalDate.now;

//A lease Backend.company. In addition to Company superclass, it has Backend.vehicles and lease contracts.
...
public class LeaseCompany extends Company {
    ...
    //Constructor that initialises the class with a specified maximum possible number of contracts and Backend.vehicles.
    ...
    //add vehicle to the lease Backend.company
    ...
    //add contract to the lease Backend.company
    ...
    //get Backend.vehicles contracts from the leasecompanies
    ...
    //Returns number of available Backend.vehicles
    ...
    //Returns Array of available Backend.vehicles
    ...
    //Prints details of all Backend.vehicles
    ...
    //prints out the details of the available Backend.vehicles
