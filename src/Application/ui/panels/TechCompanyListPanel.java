...
import Application.Backend.company.TechCompany;
...
/**
 * Shows a list of companies, functions to add companies and edit a ApplicationBE.Backend.company
 * @author Daniel
 */
public class TechCompanyListPanel extends Panel {
    ...
    public TechCompanyListPanel(){
        ...
        // Add button
        addButton = new Button("Add ApplicationBE.Backend.company");
        ...
        // Edit button
        editButton = new Button("Edit ApplicationBE.Backend.company");
        ...
        list.addItemListener(new ItemListener() {
            ...
            public void itemStateChanged(ItemEvent e) {
                // Store the selected ApplicationBE.Backend.company in a String
    ...
    private void handleInput(){
        ...
        // Otherwise, add the ApplicationBE.Backend.company to the list
